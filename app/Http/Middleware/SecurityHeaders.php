    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if ($usesCsp) {
            $response->headers->set(
                ...
                implode('; ', [
                    "default-src 'self'",
                    "script-src 'self' 'nonce-{$nonce}' https://accounts.google.com https://www.gstatic.com https://www.googletagmanager.com https://connect.facebook.net",
                    "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
                    "font-src 'self' https://fonts.gstatic.com data:",
                    "img-src 'self' data: https: blob:",
                    "worker-src 'self' blob:",
                    "frame-src https://www.openstreetmap.org https://td.doubleclick.net",
                    "connect-src 'self' https://nominatim.openstreetmap.org https://accounts.google.com https://oauth2.googleapis.com https://www.google-analytics.com https://analytics.google.com https://stats.g.doubleclick.net https://www.facebook.com https://connect.facebook.net",
                    "object-src 'none'",
                    "base-uri 'self'",
