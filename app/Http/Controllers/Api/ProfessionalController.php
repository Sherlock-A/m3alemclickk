...
class ProfessionalController extends Controller
{
    ...
    private static function synonyms(string $norm): array
    {
        $map = [
            ...
            'electricite'   => ['electri'],
            'menage'        => ['menag', 'nettoy'],
            'nettoyage'     => ['nettoy', 'menag'],
            'demenagement'  => ['demena'],
            'informatique'  => ['informat', 'reseau'],
            'maconnerie'    => ['macon'],
            'serrurerie'    => ['serrur'],
            'jardinage'     => ['jardin'],
            'menuiserie'    => ['menuisi'],
            'peinture'      => ['peintr'],
            'soudure'       => ['soud', 'ferronn'],
            'climatisation' => ['clim', 'froid', 'hvac'],
            'carrelage'     => ['carrel'],
            'vitrerie'      => ['vitr'],
            'chauffage'     => ['chauff'],
            'coiffure'      => ['coiff', 'barbier'],
            'photographie'  => ['photo'],
            'decoration'    => ['decor', 'design'],
            'charpenterie'  => ['charpen', 'couvreur'],
            // métier → même racine (bidirectionnel)
            'plombier'      => ['plomb'],
            'electricien'   => ['electri'],
            'macon'         => ['macon'],
            'serrurier'     => ['serrur'],
            ...
            'decorateur'    => ['decor'],
            'charpentier'   => ['charpen'],
            'couvreur'      => ['couvreur', 'charpen'],
            'ferronnier'    => ['ferronn', 'soud'],
            'paysagiste'    => ['jardin', 'paysag'],
        ];
